...
Widget itemLayoutWidget(
  ...
  String layoutStyle = item.layout;
            ...
            children: [
              Container( // Icon
                  ...
                  child: ConstrainedBox(
                      ...
                      child: Container(
                          child: Image.asset(item.keyPhoto, fit: BoxFit.fill)
                      )
                  )
              ),
              Expanded(
                ...
                SizedBox(
                  ...
                  child: Flex(
                    ...
                    children: _fillImages(
                        item, database, numberOfImages, remainingWidth, _rowHeight),
                  ),
                ),
                Container(
                    child: Align(
            ...
            child: Stack(
              children: [
                SizedBox(
                  ...
                  child: DecoratedBox(
                    child: Container(
                        child: Image.asset(item.keyPhoto, fit: BoxFit.fitWidth)
                    ),
                    decoration: BoxDecoration(
...
_fillImages(item, database, n, r, h){
  var imageAssets = database.getAllImages(item);
